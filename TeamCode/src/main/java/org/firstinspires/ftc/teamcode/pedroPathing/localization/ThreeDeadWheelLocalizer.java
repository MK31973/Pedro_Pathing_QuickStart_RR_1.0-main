...
public final class ThreeDeadWheelLocalizer extends Localizer {
    public static class Params {
        public double par0YTicks = -2452.165233066315;//-2441.9133801212834;//-2426.512456471011; y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2130.4097255063666; //2467.6258;//2467.9133801212834;//2530.6258; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2000.8226002678518; //-466.222994370873; //-566.222994370873; //-650.620899175634;//-560.3783221003024; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public double inPerTick = 0.0029519200749298; //0.002934; //24.0 / 8163.0;;
...
//    public static double IMU_INTERVAL = 100.0;
    ...
    public ThreeDeadWheelLocalizer(HardwareMap hardwareMap) {
        ...
        par1 = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "rightEnc")));
        perp = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "backEnc")));
